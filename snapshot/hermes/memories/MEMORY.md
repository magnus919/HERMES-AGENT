...
§
On this machine, the Hermes venv at /home/ubuntu/.hermes/hermes-agent/venv may be missing pip initially; bootstrap with `python -m ensurepip --upgrade` before installing Python deps into that venv.
§
