...
| `No module named pip` during `--install-deps` | Bootstrap pip in the Hermes venv first: `/home/ubuntu/.hermes/hermes-agent/venv/bin/python -m ensurepip --upgrade`, then rerun `$GSETUP --install-deps` |
